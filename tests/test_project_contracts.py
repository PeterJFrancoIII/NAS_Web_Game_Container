...
class RuntimeImageContractTest(unittest.TestCase):
    ...
    def test_webrtc_latency_preset_and_stable_baseline(self):
        ...
        self.assertIn("WEBRTC_LATENCY_PRESET=low", env_example)
        self.assertIn("WEBRTC_VIDEO_CODEC=H264", env_example)
        self.assertIn("WEBRTC_VIDEO_FPS=30", env_example)
        self.assertIn("WEBRTC_VIDEO_BITRATE=1500000", env_example)
...
class UltraStreamingContractTest(unittest.TestCase):
    ...
    def test_ultra_transport_menu_and_settings_protocol(self):
        ...
        self.assertIn("webrtcLatencyPreset", html)
        self.assertIn('<option value="low" selected>Low latency (30 fps)</option>', html)
        ...
        self.assertIn("ALLOWED_WEBRTC_LATENCY_PRESETS", gateway)
        self.assertIn("_restart_webrtc_media", gateway)
        self.assertIn("webrtcLatencyPreset", gateway)
        ...
        self.assertIn("run-webrtc-tests.sh", read("scripts/redeploy-ultra.sh"))
