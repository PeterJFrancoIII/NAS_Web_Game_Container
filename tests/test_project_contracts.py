...
class UltraStreamingContractTest(unittest.TestCase):
    def test_ultra_compose_uses_minimal_image_and_single_port_gateway(self):
        ...
        self.assertIn("Xvfb :1 -screen 0 %(ENV_RESOLUTION)sx%(ENV_RA2_DISPLAY_DEPTH)s", supervisor)
    ...
    def test_ultra_gateway_and_helper_implement_wss_webcodecs_path(self):
        ...
        self.assertIn("replaced_by_new_session", gateway)
        self.assertIn("replaced by a newer stream session", gateway)
        ...
        self.assertIn("video diagnostics", game)
    ...
    def test_ultra_transport_menu_and_settings_protocol(self):
        ...
        self.assertIn('<option value="300000">300 kbps</option>', html)
        ...
        self.assertIn("H.265 / HEVC 8-bit (hardware)", html)
        self.assertIn("H.265 / HEVC 10-bit (hardware)", html)
        self.assertIn('<option value="H265_10">', html)
        self.assertIn("videoResolution", html)
        self.assertIn('<option value="native" selected>Native (game display)</option>', html)
        self.assertIn('<option value="800x600">800 x 600</option>', html)
        ...
        self.assertIn('"videoResolution"', gateway)
        self.assertIn("set_stream_size", gateway)
        ...
        self.assertIn("decoder: ${activeVideoDecoderCodec}", ultra_js)
        self.assertIn("encoded video: ${encodedVideoKbps.toFixed(0)} kbps", ultra_js)
        ...
        self.assertIn('videoResolution: "native"', ultra_js)
        self.assertIn("videoResolutionEl", ultra_js)
